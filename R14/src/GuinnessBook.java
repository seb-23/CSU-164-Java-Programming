...
public class GuinnessBook {
	...
	public GuinnessBook(String filename) throws FileNotFoundException{
		...
		while(scan.hasNextLine()){
			...
			Animal c = new Animal(animalName, topSpeed);
			landAnimals.add(c);
	...
	public String toString(){
		...
		for (int i = 0; i < landAnimals.size(); i++) {
			output += "Name: " + landAnimals.get(i).getName().toString() + "     Top Speed: " + landAnimals.get(i).gettopSpeed() + "\n";
